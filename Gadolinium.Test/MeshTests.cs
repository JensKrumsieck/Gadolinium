...
public class MeshTests
{
    ...
    {
        var m1 = MeshBuilder.Sphere(Vector3.UnitZ * 2, 1f, 32, 64);
        var m2 = MeshBuilder.Sphere(-Vector3.UnitY * 2, 1f, 64, 128);
        var m3 = MeshBuilder.Sphere(-Vector3.UnitX * 2, 1f, 128, 256);
        var m4 = new Mesh();
        m4.Add(m1);
        m4.Add(m2);
        m4.Add(m3);
